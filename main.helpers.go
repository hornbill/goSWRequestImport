...
func parseFlags() {
	...
	flag.BoolVar(&boolProcessAttachments, "attachments", false, "Import attachments without prompting. (defunct)")
	flag.BoolVar(&boolNoAttachments, "NoAttachments", false, "Block Attachments Import")
